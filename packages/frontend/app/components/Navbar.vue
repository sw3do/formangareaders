<template>
  <nav class="sticky top-0 z-50 bg-white/80 dark:bg-gray-900/80 backdrop-blur-2xl border-b border-gray-200/30 dark:border-gray-700/30 shadow-lg shadow-gray-200/20 dark:shadow-gray-900/20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center h-20">
        <div class="flex items-center space-x-3 sm:space-x-6">
          ...
          <NuxtLink to="/" class="flex items-center space-x-2 sm:space-x-4 group">
            <div class="relative">
              <div class="w-10 h-10 sm:w-12 sm:h-12 bg-linear-to-br from-blue-500 via-purple-500 to-indigo-600 rounded-2xl flex items-center justify-center shadow-xl group-hover:shadow-2xl transition-all duration-500 group-hover:scale-110 group-hover:rotate-3">
                <Icon name="i-heroicons-book-open" class="w-5 h-5 sm:w-7 sm:h-7 text-white" />
              </div>
              <div class="absolute -top-1 -right-1 w-3 h-3 sm:w-4 sm:h-4 bg-linear-to-r from-green-400 to-emerald-500 rounded-full border-2 border-white dark:border-gray-900 animate-pulse"></div>
            </div>
            <div class="hidden sm:block">
              <span class="text-xl sm:text-2xl font-black bg-linear-to-r from-gray-900 via-blue-800 to-purple-800 dark:from-white dark:via-blue-200 dark:to-purple-200 bg-clip-text text-transparent group-hover:from-blue-600 group-hover:via-purple-600 group-hover:to-indigo-600 transition-all duration-500">
                ForManga
              </span>
              <div class="text-xs font-semibold text-gray-500 dark:text-gray-400 group-hover:text-blue-500 dark:group-hover:text-blue-400 transition-all duration-300 tracking-wider">
                READERS
              </div>
            </div>
          </NuxtLink>
        ...
        <div class="hidden lg:flex items-center space-x-1">
          ...
          >
            ...
            <div class="absolute inset-0 bg-linear-to-r from-blue-500/20 via-purple-500/20 to-indigo-500/20 rounded-2xl opacity-0 group-hover:opacity-100 transition-all duration-500 blur-sm"></div>
          </NuxtLink>
        </div>
        ...
        <div class="flex items-center space-x-2 sm:space-x-4">
            ...
            >
              <template #trailing>
                <div class="flex items-center space-x-2">
                  <UKbd size="sm" class="bg-linear-to-r from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-600 text-gray-600 dark:text-gray-300 border-gray-300 dark:border-gray-600 rounded-lg shadow-sm">⌘K</UKbd>
                </div>
              </template>
            </UInput>
            <div class="absolute inset-0 bg-linear-to-r from-blue-500/10 to-purple-500/10 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"></div>
          </div>
          ...
          <div class="relative z-50 bg-linear-to-r from-gray-100/60 to-gray-200/60 dark:from-gray-800/60 dark:to-gray-700/60 rounded-2xl p-1 sm:p-2 shadow-lg backdrop-blur-sm border border-gray-200/30 dark:border-gray-600/30">
            <LanguageSwitcher />
          </div>
          ...
          <UPopover>
            <div class="relative group">
              <div class="p-0.5 sm:p-1 bg-linear-to-r from-blue-500 via-purple-500 to-indigo-500 rounded-2xl shadow-xl group-hover:shadow-2xl transition-all duration-500 group-hover:scale-110">
                <UAvatar
              ...
              <div class="absolute -top-1 -right-1 w-3 h-3 sm:w-4 sm:h-4 bg-linear-to-r from-green-400 to-emerald-500 rounded-full border-2 border-white dark:border-gray-900 animate-pulse shadow-lg"></div>
            </div>
            <template #panel>
              <div class="p-4 w-64 bg-white/95 dark:bg-gray-900/95 backdrop-blur-2xl border border-gray-200/30 dark:border-gray-700/30 rounded-3xl shadow-2xl">
                <div class="space-y-3">
                  <div class="px-4 py-3 border-b border-gray-200 dark:border-gray-700 rounded-2xl bg-linear-to-r from-gray-50/50 to-gray-100/50 dark:from-gray-800/50 dark:to-gray-700/50">
                  ...
                  <div class="border-t border-gradient-to-r from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-700 my-3"></div>
                  <UButton
                    variant="ghost"
                    color="neutral"
                    size="md"
      ...
      <div v-if="showMobileSearch" class="md:hidden py-6 border-t border-gray-200/30 dark:border-gray-700/30 bg-linear-to-r from-gray-50/80 to-white/80 dark:from-gray-800/80 dark:to-gray-900/80 backdrop-blur-xl">
        <UInput
          v-model="searchQuery"
          :placeholder="$t('nav.search')"
          icon="i-heroicons-magnifying-glass"
